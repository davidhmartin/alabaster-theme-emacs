;;; alabaster-low-contrast-theme.el --- Alabaster Low Contrast theme for Emacs -*- lexical-binding: t; -*-
...
;; A low-contrast light variant of Alabaster with a warm, paper-like feel.
;; Same philosophy as Alabaster: highlight only what matters.
;;
;; Alabaster only highlights FOUR categories:
;; 1. Strings (muted green) - including regexps and symbols
;; 2. Constants (muted purple) - numbers, booleans, language constants
;; 3. Comments (muted red) - still noticeable, but softer
...
(deftheme alabaster-low-contrast
  "Alabaster Low Contrast - A gentle, paper-like light theme.
Reduced contrast for comfortable extended reading and coding.")

(let ((class '((class color) (min-colors 89)))
      ;; Color palette - warm, reduced contrast
      (bg           "#EDE8E2")   ; warm cream (darker than #F7F7F7)
      (bg-alt       "#E3DED8")   ; slightly darker cream
      (fg           "#4A4540")   ; warm dark gray (softer than black)
      (fg-dim       "#8A8580")   ; warm medium gray
      (punctuation  "#8A8580")
      ;; Core highlighting - muted versions of the four categories
      (string       "#5A7A4A")   ; muted forest green
      (constant     "#6A5088")   ; muted purple
      (comment      "#986A65")   ; muted terracotta (softer than red)
      (definition   "#4A6A90")   ; muted slate blue
      ;; UI colors
      (selection    "#D0D8E8")   ; soft blue selection
      (highlight    "#5A8AC0")
      (find-hl      "#E8CFA0")   ; soft amber
      ;; Status colors - muted
      (error-red    "#B05050")
      (warning-org  "#A07830")
      (success-grn  "#5A8A5A")
  ...
  (custom-theme-set-faces
   ...
   ;; Comments (muted terracotta - still readable, but softer)
   `(font-lock-comment-face ((,class (:foreground ,comment))))
   `(font-lock-comment-delimiter-face ((,class (:foreground ,comment))))
   `(font-lock-doc-face ((,class (:foreground ,comment))))

   ;; Definitions (muted slate blue)
   ...
   `(show-paren-mismatch ((,class (:foreground ,bg :background ,error-red))))
   ...
   `(diff-refine-added ((,class (:foreground ,fg :background "#B8D8B8"))))
   `(diff-refine-removed ((,class (:foreground ,fg :background "#D8B8B8"))))
   `(diff-refine-changed ((,class (:foreground ,fg :background "#D8D8A8"))))
...
(provide-theme 'alabaster-low-contrast)

;;; alabaster-low-contrast-theme.el ends here
