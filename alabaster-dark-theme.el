;;; alabaster-dark-theme.el --- Alabaster Dark theme for Emacs -*- lexical-binding: t; -*-
...
;; Alabaster Dark is the dark variant of the minimalist Alabaster theme.
;; It follows the same philosophy: highlight only what matters.
;;
;; Alabaster only highlights FOUR categories:
;; 1. Strings (muted green) - including regexps and symbols
;; 2. Constants (lavender) - numbers, booleans, language constants
;; 3. Comments (yellow) - prominently, NOT dimmed
;; 4. Global definitions (light blue) - function/class/variable definitions
;;
...
(deftheme alabaster-dark
  "Alabaster Dark - A minimalist dark theme that highlights what matters.
...
(let ((class '((class color) (min-colors 89)))
      ...
      (string       "#99C592")   ; muted green - strings, regexps, symbols
      (constant     "#9999FF")   ; lavender - numbers, booleans, constants
      (comment      "#DFDF8E")   ; yellow - comments (prominent!)
      (definition   "#71ADE7")   ; light blue - function/class/var definitions
      ;; UI colors
      (selection    "#264F78")
      (highlight    "#007ACC")
      (find-hl      "#9E6A03")
  ...
  (custom-theme-set-faces
   ...
   ;; Comments (yellow - PROMINENT, not dimmed!)
   `(font-lock-comment-face ((,class (:foreground ,comment))))
   `(font-lock-comment-delimiter-face ((,class (:foreground ,comment))))
   `(font-lock-doc-face ((,class (:foreground ,comment))))

   ;; Definitions (light blue)
   ...
   `(diff-refine-added ((,class (:foreground ,fg :background "#2D5A3D"))))
   `(diff-refine-removed ((,class (:foreground ,fg :background "#5A2D2D"))))
   `(diff-refine-changed ((,class (:foreground ,fg :background "#5A5A2D"))))
   ...
   ;; === Term / Ansi ===
   `(term-color-black ((,class (:foreground "#3F4A4B" :background "#3F4A4B"))))
